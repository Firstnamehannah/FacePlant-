...
linkml_meta = LinkMLMeta({'default_prefix': 'faceplant',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'faceplant': {'prefix_prefix': 'faceplant',
                                'prefix_reference': 'https://w3id.org/firstnamehannah/FacePlant/'},
                  'linkml': {'prefix_prefix': 'linkml',
                             'prefix_reference': 'https://w3id.org/linkml/'},
                  'schema': {'prefix_prefix': 'schema',
                             'prefix_reference': 'http://schema.org/'}},
     'see_also': ['https://firstnamehannah.github.io/FacePlant'],
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/firstnamehannah/FacePlant'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/firstnamehannah/FacePlant',
...
class PersonCollection(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/firstnamehannah/FacePlant', 'tree_root': True})
